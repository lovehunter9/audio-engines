...
def _load():
    try:
        ...
        # Missing stamp used to rmtree a working IR; write the stamp after a successful load instead.
...
def _pcm_list(audio):
    # WhisperPipeline.generate wants Sequence[float]; pybind rejects a torch tensor or numpy.
