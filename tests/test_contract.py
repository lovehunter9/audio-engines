...
class TtsOvCausalHelpersTest(unittest.TestCase):
    ...
    def test_breeze_install_does_not_swallow_export_failure(self):
        ...
        self.assertIn("quantizer.decode", codec)
        self.assertIn("pre_transformer", codec)
        self.assertIn("ExecutionLane.run_step", codec)
        self.assertIn("compile_module", codec)
        self.assertIn(".ov-breeze-codec-v3", codec)
        ...
        self.assertIn("firered_llm_decode", bb)
        self.assertNotIn("firered_llm_prefill", bb)
        ...
        self.assertIn("query_state", inspect.getsource(tts_ov.StatefulKvRunner))
        self.assertIn("st.state =", inspect.getsource(tts_ov.StatefulKvRunner))
        self.assertNotIn("set_state", inspect.getsource(tts_ov.StatefulKvRunner))
        ...
        self.assertIn("official prefill", inspect.getsource(firered._install_firered_backbone))
