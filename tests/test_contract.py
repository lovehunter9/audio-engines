...
class TtsOvCausalHelpersTest(unittest.TestCase):
    ...
    def test_breeze_install_does_not_swallow_export_failure(self):
        ...
        self.assertIn(".ov-breeze-codec-quant-v8", codec)
        self.assertIn(".ov-breeze-codec-pre-v8", codec)
        self.assertIn(".ov-breeze-codec-tail-v8", codec)
        ...
        self.assertIn("OV prefill", inspect.getsource(firered._install_firered_backbone))
