...
class TtsOvCausalHelpersTest(unittest.TestCase):
    ...
    def test_breeze_install_does_not_swallow_export_failure(self):
        ...
        self.assertIn("_cfg_sample", depth)
        self.assertIn("breeze_depth_prefill", depth)
        self.assertIn(".ov-breeze-depth-prefill-v1", depth)
        self.assertIn("breeze_depth_decode", depth)
        self.assertIn(".ov-breeze-depth-decode-v1", depth)
        self.assertIn("StatefulKvRunner", depth)
        self.assertIn("external_position=True", depth)
        self.assertIn("kv_from=3", depth)
        self.assertIn("seed_flat", depth)
        self.assertIn("runner.step(step, position=cache_pos)", depth)
        self.assertIn("dynamize_ranks=(2, 4)", depth)
        self.assertNotIn("breeze_depth_stack", depth)
        ...
        self.assertNotIn("fused_depth_frame", depth)
