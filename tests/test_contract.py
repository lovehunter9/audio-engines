...
class TtsOvCausalHelpersTest(unittest.TestCase):
    ...
    def test_breeze_install_does_not_swallow_export_failure(self):
        ...
        self.assertIn("dtype=seg.dtype", text)
        ...
        self.assertIn(".ov-breeze-codec-v5", codec)
        ...
        self.assertIn("firered_llm_decode_q", bb)
        self.assertIn(".ov-firered-v13", bb)
        self.assertIn("patch_size", bb)
        self.assertIn("runners", bb)
