...
class TtsOvCausalHelpersTest(unittest.TestCase):
    ...
    def test_breeze_install_does_not_swallow_export_failure(self):
        ...
        self.assertIn("StatefulKvRunner", src)
        self.assertIn("stateful=True", src)
        self.assertIn("seed_flat", src)
        self.assertIn("backbone.float()", src)
        self.assertIn(".ov-breeze-v12", src)
        self.assertIn("external_position=True", src)
        self.assertIn("kv_from=3", src)
        self.assertIn("position_ids", src)
        ...
        self.assertLess(src.index("backbone.float()"), src.index("breeze_backbone_decode"))
        self.assertLess(src.index("breeze_backbone_decode"), src.index("breeze_backbone_prefill"))
        ...
        self.assertIn("official codebook loop", depth)
        ...
        self.assertNotIn("release_parameters", depth)
        self.assertNotIn("DepthDecoderGraph._full_loop =", depth)
        self.assertNotIn("compile_causal", depth)
